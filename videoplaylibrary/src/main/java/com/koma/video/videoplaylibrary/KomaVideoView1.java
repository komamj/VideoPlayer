...
public class KomaVideoView1 extends SurfaceView implements KomaMediaController.MediaPlayerControl {
    ...
    public KomaVideoView1(Context context) {
        super(context);
        initVideoView(context);
    }

    public KomaVideoView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initVideoView(context);
    }

    public KomaVideoView1(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public KomaVideoView1(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public CharSequence getAccessibilityClassName() {
        return KomaVideoView1.class.getName();
    }
             ...
             */
                    if (getWindowToken() != null) {
                        new AlertDialog.Builder(getContext(), R.style.AlertDialogTheme)
                                .setMessage(R.string.can_not_play_this_file)
    ...
    private AudioManager.OnAudioFocusChangeListener mAudioFocusChangeListener = new
            AudioManager.OnAudioFocusChangeListener() {
                ...
                public void onAudioFocusChange(int focusChange) {
                    KomaLogUtils.i(TAG, "onAudioFocusChange focusChange : " + focusChange);
                    switch (focusChange) {
   ...
   /* @Override
        ...
        if (isInPlaybackState()) {
            if (mMediaPlayer.isPlaying()) {
                ...
                if (mPauseListener != null) {
                    mPauseListener.updatePauseState();
                }
                if (mMediaController != null) {
                    mMediaController.updatePausePlay();
                }
    ...
    protected void onAttachedToWindow() {
        ...
        KomaLogUtils.i(TAG, "onAttachedToWindow");
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        KomaLogUtils.i(TAG, "onDetachedFromWindow");
    }
